...
export class Description_ extends React.Component<Props & { theme: Theme }, State> {
    ...
    render() {
        return (
            <Container onMouseEnter={this.showTooltip} onMouseLeave={this.hideTooltip} onClick={this.toggleTooltip}>
                ...
                <Tooltip visible={this.state.tooltipIsVisible}>{this.props.description}</Tooltip>
            </Container>
        );
    }
}
